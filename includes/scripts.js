...
document.addEventListener('change', function (e) {
  if (e.target.id === 'tipo_agendamento') {
    ...
    if (tipo === 'consulta') {
      // CONSULTA: mostra prestador (obrigatório), especialidade e esconde procedimento
      campoPrestador.style.display = 'block';
      campoProcedimento.style.display = 'none';
      if (campoEspecialidade) campoEspecialidade.style.display = 'block';
      ...
      // PROCEDIMENTO: mostra prestador (opcional) e procedimento (obrigatório), esconde especialidade
      campoPrestador.style.display = 'block';
      campoProcedimento.style.display = 'block';
      if (campoEspecialidade) campoEspecialidade.style.display = 'none';
