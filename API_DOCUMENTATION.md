...
[![API Version](https://img.shields.io/badge/API-v2.5-green.svg)](README.md)
[![Status](https://img.shields.io/badge/Status-Production-success.svg)]()
[![Last Update](https://img.shields.io/badge/Updated-31%2F10%2F2025-blue.svg)]()

> 📢 **Versão 2.5** - 🎉 API 100% JSON - Todos os endpoints retornam JSON puro
...
**TODOS os endpoints da API agora retornam JSON puro!**

1. **✅ listar_agendas.php Convertido**
   - Endpoint principal agora retorna JSON estruturado
   - Dados completos: horários, convênios, vagas, observações
   - Correção automática de caracteres especiais (º, ª, ç)
   - Encoding UTF-8 garantido

2. **🔧 Correções de Encoding**
   - Função `corrigirCaracteres()` para bytes corrompidos do Firebird
   - "2º andar" em vez de "2� andar"
   - Acentuação perfeita em todos os campos
   - Flag `JSON_INVALID_UTF8_SUBSTITUTE` para máxima compatibilidade

3. **📊 8 Arquivos Convertidos**
   - buscar_agendas.php
   - buscar_bloqueios.php
   - buscar_convenio_ajax.php
   - listar_agendados.php
   - listar_agendas_ajax.php
   - **listar_agendas.php** ⭐ NOVO
   - listar_paginas.php
   - verificar_estrutura_tabelas.php

**📄 Documentação:** [CONVERSAO_API_JSON.md](CONVERSAO_API_JSON.md)
...
#### Listar Agendas (JSON) ⭐ ATUALIZADO v2.5
Retorna lista de agendas por tipo e nome em formato JSON estruturado.

**Requisição:**
```http
GET /listar_agendas.php?tipo={tipo}&nome={nome}&dia={dia}&cidade={cidade_id}
```

**Parâmetros de Query:**
- `tipo` (string, **obrigatório**): Tipo da agenda ("consulta" ou "procedimento")
- `nome` (string, **obrigatório**): Nome da especialidade ou procedimento
...
```bash
GET /listar_agendas.php?tipo=consulta&nome=Cardiologista
```
  ...
  "agendas": [
    {
      ...
      "idade_minima": 0,
      "possui_retorno": true,
      "limite_retornos_dia": 0,
      "atende_comorbidade": false,
      "limite_vagas_dia": 0,
      "limite_encaixes_dia": 0,
      "horarios": [
        {
          "dia_semana": "Segunda",
          "turnos": [
...
- ✅ Caracteres especiais corrigidos automaticamente (º, ª, ç)
- ✅ Horários estruturados por período e dia
- ✅ Encoding UTF-8 garantido
- ✅ Compatível com frameworks JavaScript e mobile
...
### v2.5 (31 Outubro 2025) - 🎉 **API 100% JSON**
- ✅ **CONVERSÃO COMPLETA:** Todos os endpoints da API agora retornam JSON puro
- ✅ **ENDPOINT PRINCIPAL:** `listar_agendas.php` convertido para JSON estruturado
- ✅ **CORREÇÃO DE ENCODING:** Função `corrigirCaracteres()` para bytes corrompidos do Firebird
- ✅ **CARACTERES ESPECIAIS:** "2º andar" em vez de "2� andar", acentuação perfeita
- ✅ **8 ARQUIVOS CONVERTIDOS:** buscar_agendas, buscar_bloqueios, buscar_convenio_ajax, listar_agendados, listar_agendas_ajax, listar_agendas, listar_paginas, verificar_estrutura_tabelas
- ✅ **ENCODING UTF-8:** Flag `JSON_INVALID_UTF8_SUBSTITUTE` para máxima compatibilidade
- ✅ **DOCUMENTAÇÃO:** Arquivo CONVERSAO_API_JSON.md criado com detalhes completos
- ✅ **BACKUP AUTOMÁTICO:** Todos os arquivos foram backupeados antes da conversão
- ✅ **TESTES:** Todos os endpoints testados e validados
...
**Versão da API:** 2.5
**Última atualização:** 31 Outubro 2025
**Status:** ✅ 100% JSON - Testada e Funcionando
**Otimizada para:** 🤖 Agentes de IA, Web, Mobile